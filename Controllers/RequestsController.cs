...
namespace MVCFinalProject.Controllers
{
    public class RequestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RequestId,RequsetDate,RequestTax,RecipeId,UserId")] Request request)
        {
            ...
            ViewData["RecipeId"] = new SelectList(_context.Recipes, "RecipeId", "RecipeId", request.RecipeId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("RequestId,RequsetDate,RequestTax,RecipeId,UserId")] Request request)
        {
