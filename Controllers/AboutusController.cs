...
namespace MVCFinalProject.Controllers
{
    public class AboutusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ImgPath,Content")] Aboutu aboutu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,ImgPath,Content")] Aboutu aboutu)
        {
            if (id != aboutu.Id)
            {
                return NotFound();
