...
namespace MVCFinalProject.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Email,Subject,Message")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,UserName,Email,Subject,Message")] Contactu contactu)
        {
            if (id != contactu.Id)
            {
                return NotFound();
